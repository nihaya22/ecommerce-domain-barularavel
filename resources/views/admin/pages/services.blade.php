    ...
    <div class="px-6 py-4 border-b border-brand-100 bg-white/70">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div class="text-sm text-slate-600">
                Total: <span class="font-semibold text-slate-900">{{ is_array($services) ? count($services) : 0 }}</span> service
            </div>
                    ...
                    @foreach($services as $service)
                        <tr class="hover:bg-brand-50/60 transition">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-slate-500 mt-0.5">Service ID: {{ $service['id'] }}</div>
                            </td>
